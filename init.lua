--[[
Sorry for anyone who's used to Bedrock... Java comes first in the list, so I 
started using that, and now I'm not going to change it. I don't even play MineCraft,
so I don't care.
]]
...
local aliases = {
    ...
    ["mcl_enchanting:table"] = "enchanting_dable",
...
minetest.register_on_mods_loaded(function()
    for itemstring, def in pairs(minetest.registered_items) do
        ...
        if not mod_name then --such as 'air'
            mod_name = ""
